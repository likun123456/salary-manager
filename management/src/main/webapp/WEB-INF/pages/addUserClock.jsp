    ...
    <div class="panel_content">
        <table border="1" width="550" cellspacing="0" cellpadding="0">
            ...
            <c:forEach items="${list}" var="userInfo">
                <fm:form action="replenishUserClock" method="post">
                    <tr>
                        ...
                        <td width="150" class="info" align="center">
                            <b>${userInfo.realName}</b>
                            <input type="hidden" value="${userInfo.realName}" name="realName">
                        </td>
                        <td width="150" align="center">
                            <input id='time' name="date" value="2020-05-25" type="date"/>
                        </td>
                        <td width="150" align="center">
                            <button class="subbtn" type="submit">补签</button>
                        </td>
                    </tr>
                </fm:form>
            </c:forEach>
